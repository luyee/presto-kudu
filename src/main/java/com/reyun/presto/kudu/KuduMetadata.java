        ...
        implements ConnectorMetadata
{
    ...
    {
        KuduTableLayoutHandle layout = checkType(handle, KuduTableLayoutHandle.class, "layout");
    ...
    {
        checkType(tableHandle, KuduTableHandle.class, "tableHandle");
        return checkType(columnHandle, KuduColumnHandle.class, "columnHandle").toColumnMetadata();
    }
